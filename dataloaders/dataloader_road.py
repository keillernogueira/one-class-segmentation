...
class DataLoaderRoad(data.Dataset):
    ...
    def load_images(self):
        ...
        for img in self.images:
            ...
            print('mask area', img, temp_mask.shape, np.bincount(temp_mask.astype(int).flatten()))
            print('image stats', np.min(temp_image), np.average(temp_image), np.max(temp_image))
